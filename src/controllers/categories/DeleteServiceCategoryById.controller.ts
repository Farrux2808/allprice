...
export async function DeleteServiceCategoryByIdController(req: express.Request, res: express.Response) {
  ...
  try {
    const deleted = await Repository.ServicesCategory().delete(new Types.ObjectId(idParam.id));
